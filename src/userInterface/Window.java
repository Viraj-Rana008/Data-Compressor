 ...
 * @author  admin
 */
public class Window extends javax.swing.JFrame implements Constants {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (returnVal == jFileChooser1.APPROVE_OPTION) {
            ...
            if(jRadioButton1.isSelected()){
            	    	jTextField2.setText(jTextField2.getText() + extensions[algoSelected]);
            	    }else
            	    if(jTextField1.getText().endsWith(extensions[algoSelected])){
            	    	String buf = jTextField2.getText().substring(0,jTextField2.getText().lastIndexOf(extensions[algoSelected]));
            	    	System.out.println(jTextField1.getText().lastIndexOf(extensions[algoSelected]));
                        jTextField2.setText(buf);
                         
                        
            	    	
            	    }else{
                         jTextField2.setText(jTextField1.getText() + extensions[algoSelected]);
            	    	}
        }
...
// TODO add your handling code here:
		...
		if(jRadioButton1.isSelected()){
            	    ...
            	    if(jTextField1.getText().endsWith(extensions[algoSelected])){
            	    	String buf = jTextField1.getText().substring(0,jTextField1.getText().lastIndexOf(extensions[algoSelected]));
            	    	System.out.println(jTextField1.getText().lastIndexOf(extensions[algoSelected]));
                        jTextField2.setText(buf);
